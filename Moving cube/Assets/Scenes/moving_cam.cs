...
public class CameraOrbit : MonoBehaviour
{
    ...
    public float sensitivityX = 100f; // Sensibilité pour la rotation horizontale
    public float sensitivityY = 100f; // Sensibilité pour la rotation verticale
    ...
    void Update()
    {
        ...
        float mouseX = Input.GetAxis("Mouse X") * sensitivityX * sensi;
        float mouseY = Input.GetAxis("Mouse Y") * sensitivityY * sensi;
